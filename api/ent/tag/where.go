...
// HasTagsAlbum applies the HasEdge predicate on the "tags_album" edge.
func HasTagsAlbum() predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TagsAlbumTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, TagsAlbumTable, TagsAlbumPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasTagsAlbumWith applies the HasEdge predicate on the "tags_album" edge with a given conditions (other predicates).
func HasTagsAlbumWith(preds ...predicate.Album) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TagsAlbumInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, TagsAlbumTable, TagsAlbumPrimaryKey...),
		)
...
// HasTagsArtist applies the HasEdge predicate on the "tags_artist" edge.
func HasTagsArtist() predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TagsArtistTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, TagsArtistTable, TagsArtistPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasTagsArtistWith applies the HasEdge predicate on the "tags_artist" edge with a given conditions (other predicates).
func HasTagsArtistWith(preds ...predicate.Artist) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TagsArtistInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, TagsArtistTable, TagsArtistPrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
// HasTagsReview applies the HasEdge predicate on the "tags_review" edge.
func HasTagsReview() predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TagsReviewTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, TagsReviewTable, TagsReviewPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasTagsReviewWith applies the HasEdge predicate on the "tags_review" edge with a given conditions (other predicates).
func HasTagsReviewWith(preds ...predicate.Review) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TagsReviewInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, TagsReviewTable, TagsReviewPrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
// HasTagsTopic applies the HasEdge predicate on the "tags_topic" edge.
func HasTagsTopic() predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TagsTopicTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, TagsTopicTable, TagsTopicPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasTagsTopicWith applies the HasEdge predicate on the "tags_topic" edge with a given conditions (other predicates).
func HasTagsTopicWith(preds ...predicate.Topic) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(TagsTopicInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, TagsTopicTable, TagsTopicPrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
