...
func SpotifyURL(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLEQ(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldSpotifyURL), v))
	})
}
...
func SpotifyURLNEQ(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLIn(vs ...string) predicate.Artist {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func SpotifyURLNotIn(vs ...string) predicate.Artist {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func SpotifyURLGT(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLGTE(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLLT(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLLTE(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLContains(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLHasPrefix(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLHasSuffix(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLEqualFold(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func SpotifyURLContainsFold(v string) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
...
func HasWrote() predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, WroteTable, WrotePrimaryKey...),
		)
...
func HasWroteWith(preds ...predicate.Album) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTaggedWith() predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasTaggedWithWith(preds ...predicate.Tag) predicate.Artist {
	return predicate.Artist(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
